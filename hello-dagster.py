...
def my_first_asset(context: AssetExecutionContext):
    ...
    """
    context.log.info("this is a log message of First Asset.")
    return [1, 2, 3]
...
def my_second_asset(context: AssetExecutionContext, upstream: List):
    ...
    """
    data = upstream + [4, 5, 6]
    context.log.info("this is a log message of Second asset.")
    return data
...
def my_third_asset(
    ...
    context.log.info("this is a log message of Third Asset.")
    return data
